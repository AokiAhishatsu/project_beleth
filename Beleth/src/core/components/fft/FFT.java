...
public class FFT {
	...
	public FFT(VkDeviceBundle deviceBundle, int N, int L, float t_delta,
		...
		butterflyShader = new ShaderModule(device, "res/shaders/fft/Butterfly.comp.spv", VK_SHADER_STAGE_COMPUTE_BIT);
		inversionShader = new ShaderModule(device, "res/shaders/fft/Inversion.comp.spv", VK_SHADER_STAGE_COMPUTE_BIT);
