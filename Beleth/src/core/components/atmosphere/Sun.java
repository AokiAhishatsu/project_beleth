...
public class Sun extends Renderable{
	...
	public Sun() {
	    ...
	    shaderPipeline.createVertexShader("res/shaders/sun/sun.vert.spv");
	    shaderPipeline.createFragmentShader("res/shaders/sun/sun.frag.spv");
