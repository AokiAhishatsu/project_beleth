...
public class LogicalDevice {
	...
	public HashMap<Long, DescriptorPool> getDescriptorPools() {
		return descriptorPools;
	}

	public HashMap<Long, CommandPool> getGraphicsCommandPools() {
		return graphicsCommandPools;
	}

	public HashMap<Long, CommandPool> getComputeCommandPools() {
		return computeCommandPools;
	}

	public HashMap<Long, CommandPool> getTransferCommandPools() {
