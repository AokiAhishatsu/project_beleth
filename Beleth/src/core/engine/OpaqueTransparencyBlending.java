...
public class OpaqueTransparencyBlending {
	...
	public OpaqueTransparencyBlending(VkDeviceBundle deviceBundle,
		...
		ShaderModule shader = new ComputeShader(device, "res/shaders/opaqueTransparencyBlend.comp.spv");
	...
	public VkImageView getBlendedSceneImageView() {
		return blendedSceneImageView;
	}

	public VkImageView getBlendedLightScatteringImageView() {
		return blendedLightScatteringImageView;
	}
