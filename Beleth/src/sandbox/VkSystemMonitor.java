...
public class VkSystemMonitor extends VkGUI {
	...
	public void init(VkImageView imageView, LongBuffer waitSemaphores) {
		...
		screen0.getElements().add(new VkColorPanel(new Vec4f(0,0,0,1), 0, 215, 325, 225, panelMeshBuffer, guiOverlayFbo));
		screen0.getElements().add(new VkStaticTextPanel("FPS:", 20, 45, 40, 40, fontsImageBundle.getImageView(), fontsImageBundle.getSampler(), guiOverlayFbo));
		screen0.getElements().add(new VkStaticTextPanel("CPU:", 20, 90, 40, 40, fontsImageBundle.getImageView(), fontsImageBundle.getSampler(), guiOverlayFbo));
		...
		screen0.getElements().add(new VkTexturePanel("res/textures/logo/Furimu.png", 0, 220, 310, 130, panelMeshBuffer, guiOverlayFbo));
